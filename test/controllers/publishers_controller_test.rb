...
class PublishersControllerTest < ActionController::TestCase
  ...
  test 'should create publisher' do
    assert_difference('Publisher.count') do
      post :create, publisher: { description: @publisher.description, name: @publisher.name, website: @publisher.website }
    end
  ...
  test 'should update publisher' do
    patch :update, id: @publisher, publisher: { description: @publisher.description, name: @publisher.name, website: @publisher.website }
    assert_redirected_to publisher_path(assigns(:publisher))
  end
